...
{
    /// <summary>
    /// The second planet from the <see cref="Sun"/> in the solar system.
    /// </summary>
    public class Venus : Planet
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Venus"/>.
        /// </summary>
        public Venus() : base()
        {
        }
        ...
        public Venus(double latitude, double longitude) : base(latitude, longitude)
        {
        }
