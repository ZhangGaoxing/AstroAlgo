...
{
    /// <summary>
    /// The eighth planet from the <see cref="Sun"/> in the solar system.
    /// </summary>
    public class Neptune : Planet
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Neptune"/>.
        /// </summary>
        public Neptune() : base()
        {
        }
        ...
        public Neptune(double latitude, double longitude) : base(latitude, longitude)
        {
        }
        ...
        public Neptune(double latitude, double longitude, DateTime dateTime, TimeZoneInfo localTimeZone) : base(latitude, longitude, dateTime, localTimeZone)
        {
        }
        ...
        public override Ecliptic GetHeliocentricEclipticCoordinate(DateTime time, double julianDay = 0)
        {
            ...
            return new Ecliptic
            {
                Longitude = BasicTools.SimplifyAngle((Neptune_L0(t) + Neptune_L1(t) + Neptune_L2(t) + Neptune_L3(t) + Neptune_L4(t) + Neptune_L5(t)) * (180 / Math.PI)),
